...
/*
 * mod/feedback/rb_sources/rb_source_graphical_feedback_questions.php
 *
    ...
    protected function define_columnoptions() {
        ...
        $columnoptions = array(
            ...
            new rb_column_option(
                'feedback',
                'name',
                get_string('feedbackactivity', 'rb_source_graphical_feedback_questions'),
                'feedback.name',
            ...
            new rb_column_option(
                'trainer',
                'id',
                get_string('trainerid', 'rb_source_graphical_feedback_questions'),
            ...
            new rb_column_option(
                'trainer',
                'organisationid',
                get_string('trainerorgid', 'rb_source_graphical_feedback_questions'),
            ...
            new rb_column_option(
                'trainer',
                'organisation',
                get_string('trainerorg', 'rb_source_graphical_feedback_questions'),
            ...
            new rb_column_option(
                'trainer',
                'positionid',
                get_string('trainerposid', 'rb_source_graphical_feedback_questions'),
            ...
            new rb_column_option(
                'trainer',
                'position',
                get_string('trainerpos', 'rb_source_graphical_feedback_questions'),
    ...
    protected function define_requiredcolumns() {
        ...
        $requiredcolumns = array(
            new rb_column(
                'responses',
                'number',
                get_string('numfeedbackresponses', 'rb_source_graphical_feedback_questions'),
                'base.id',
    ...
    protected function define_filteroptions() {
        $filteroptions = array(
            new rb_filter_option(
                'feedback',
                'name',
                get_string('feedbackname', 'rb_source_graphical_feedback_questions'),
                'text'
            ),
            new rb_filter_option(
                'responses',
                'number',
                get_string('numofresponses', 'rb_source_graphical_feedback_questions'),
                'number'
            ),
            new rb_filter_option(
                'responses',
    ...
    protected function define_contentoptions() {
        $contentoptions = array(
            new rb_content_option(
                'user',
                get_string('theuser', 'rb_source_graphical_feedback_questions'),
                'base.userid'
            ),
            new rb_content_option(
                'current_pos',
            ...
            new rb_content_option(
                'tag',
                get_string('course', 'rb_source_graphical_feedback_questions'),
                'tagids.idlist',
                'tagids'
            ),
            new rb_content_option(
                'trainer',
                get_string('thetrainer', 'rb_source_graphical_feedback_questions'),
                'sessiontrainer.userid',
                'sessiontrainer'
            ),
            new rb_content_option(
                'date',
                get_string('responsetime', 'rb_source_graphical_feedback_questions'),
                'base.completedtime'
            ),
        );
...
} // end of rb_source_graphical_feedback_questions class
