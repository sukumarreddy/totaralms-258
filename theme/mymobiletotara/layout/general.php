 ...
 *
 * general layout for mymobile totara theme
 *
...
$totara_core_renderer = $PAGE->get_renderer('theme_mymobile_totara');
$totaramenu = $totara_core_renderer->print_totara_menu($menudata, null, null);
          ...
          <?php } ?>
            ...
            <div class="content-secondary">
                ...
                <div data-role="fieldcontain" id="sliderdiv">
                    ...
                    <select name="slider" class="slider" data-role="slider" data-track-theme="b" id="slider">
